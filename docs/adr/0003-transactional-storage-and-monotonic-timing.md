...
- Store recent-Preset ordering and a minimal non-restorable clean-exit/active-Session interruption marker through macOS preferences APIs.
...
- Recovery export is a versioned JSON archive of Presets, preferences, Summary Records, and schema metadata. First release does not import archives.
...
The database schema, migration tooling, backup/export format, transaction boundaries for focus accounting, clock abstraction, and sleep-race handling remain detailed-design decisions.
