# Feature Context: Menu Bar Pomodoro

Status: Reference

Formal specification: [SPEC.md](SPEC.md)

Planning index: [README.md](README.md) · Implementation roadmap: [ROADMAP.md](ROADMAP.md)
...
- Grilling and design context is complete. This document preserves resolved product detail; implementation authority and ready-for-agent status live in `SPEC.md`.
...
Implementation tasks are created from the ready-for-agent `SPEC.md`; this context remains supporting evidence.
