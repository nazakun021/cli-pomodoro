...
- Added a pure notification-capability test and deterministic ad-hoc Alerts UI coverage. Current validation passes 104 Swift tests and all 9 XCUITests with zero failures or skips. The packaged five-second Session and CoreAudio evidence above validate natural completion and chime playback.
